package com.example.cfft.Game1;
...
public class Main1Activity extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    //16个方块的id
    static int[][] btnBlock = {
            {com.example.a2048.R.id.btn00, com.example.a2048.R.id.btn01, com.example.a2048.R.id.btn02, com.example.a2048.R.id.btn03},
            {com.example.a2048.R.id.btn10, com.example.a2048.R.id.btn11, com.example.a2048.R.id.btn12, com.example.a2048.R.id.btn13},
            {com.example.a2048.R.id.btn20, com.example.a2048.R.id.btn21, com.example.a2048.R.id.btn22, com.example.a2048.R.id.btn23},
            {com.example.a2048.R.id.btn30, com.example.a2048.R.id.btn31, com.example.a2048.R.id.btn32, com.example.a2048.R.id.btn33}
    };
...
//            getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
        ...
        setContentView(com.example.cfft.R.layout.activity_main1);
        initView();
        startGame();
    }
    ...
    public void initView() {
        layout = (LinearLayout) findViewById(com.example.a2048.R.id.mianLayout);
        layout.setLongClickable(true);
        layout.setOnTouchListener(this);

        btnReset = (Button) findViewById(com.example.a2048.R.id.btnReset);
        btnReset.setOnClickListener(this);
        btnUp = (Button) findViewById(com.example.a2048.R.id.btnUp);
        btnUp.setOnClickListener(this);
        mainMenu = (Button) findViewById(com.example.a2048.R.id.mainmenu);
        mainMenu.setOnClickListener(this);
        textScore = (TextView) findViewById(com.example.a2048.R.id.current_score);
        textBestScore = (TextView) findViewById(com.example.a2048.R.id.best_score);
        score = 0;         //初始化分数
        try {
...
//        logo.setOnClickListener(this);
        ...
        for (int i = 0; i < 16; i++) {
            ...
            view.setText("");
            view.setBackground(getDrawable(com.example.a2048.R.drawable.border));
        }
        textScore.setText("\n"+score);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.example.a2048.R.menu.menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.example.a2048.R.id.goOn) {
            Toast.makeText(this, "继续游戏", Toast.LENGTH_SHORT).show();
        } else if (id == com.example.a2048.R.id.newGame) {
            Toast.makeText(this, "重新开始", Toast.LENGTH_SHORT).show();
            reset();
        } else if (id == com.example.a2048.R.id.bestScore) {
            Toast.makeText(this, "最高分", Toast.LENGTH_SHORT).show();
        } else if (id == com.example.a2048.R.id.saveGame) {
            Toast.makeText(this, "已保存游戏", Toast.LENGTH_SHORT).show();
        } else if (id == com.example.a2048.R.id.quit) {
            finish();
        }
...
//            Toast.makeText(this,"按钮menu被按下",Toast.LENGTH_SHORT).show();
            ...
            popup.show();*/
        if (v.getId() == com.example.a2048.R.id.mainmenu) {
            openOptionsMenu();
        } else if (v.getId() == com.example.a2048.R.id.btnReset) {
            reset();
        } else if (v.getId() == com.example.a2048.R.id.btnUp) {
            backToLast();
        }
    }
...
//            btn.setBackgroundColor(0xffeee4da);
                btn.setBackground(getDrawable(com.example.a2048.R.drawable.border2));
                flag[next / 4][next % 4] = 2;
            } else {                 //10-15则出现方块4
                btn.setText("4");
//            btn.setBackgroundColor(0xffeee4da);
                btn.setBackground(getDrawable(com.example.a2048.R.drawable.border4));
                flag[next / 4][next % 4] = 4;
            }
        } else {
            Toast.makeText(Main1Activity.this, "GAME OVER", Toast.LENGTH_SHORT);
            reset();
        }
...
//                btn.setBackgroundColor(0x000000);
                btn.setBackground(getDrawable(com.example.a2048.R.drawable.border));
                btn.setText("");
                break;
            case 2:
                btn = (TextView) findViewById(btnBlock[x][y]);
...
//                btn.setBackgroundColor(0xfff2b179);
                btn.setBackground(getDrawable(com.example.a2048.R.drawable.border8));
                btn.setText(String.valueOf(flag));
                break;
            case 16:
                btn = (TextView) findViewById(btnBlock[x][y]);
...
//                btn.setBackgroundColor(0xfff59563);
                btn.setBackground(getDrawable(com.example.a2048.R.drawable.border16));
                btn.setText(String.valueOf(flag));
                break;
            case 32:
                btn = (TextView) findViewById(btnBlock[x][y]);
...
//                btn.setBackgroundColor(0xfff67c5f);
                btn.setBackground(getDrawable(com.example.a2048.R.drawable.border32));
                btn.setText(String.valueOf(flag));
                break;
            case 64:
                btn = (TextView) findViewById(btnBlock[x][y]);
...
//                btn.setBackgroundColor(0xfff65e3b);
                btn.setBackground(getDrawable(com.example.a2048.R.drawable.border64));
                btn.setText(String.valueOf(flag));
                break;
            case 128:
                btn = (TextView) findViewById(btnBlock[x][y]);
