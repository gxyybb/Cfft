package com.example.cfft.control;
...
import com.example.cfft.MainHandlerConstant;
...
public class MySyntherizer implements MainHandlerConstant {
    ...
    protected boolean init(InitConfig config) {
        ...
        // com.example.cfft.listener = new SwitchSpeakerListener(mainHandler,context,this); // 测试播放过程中切换发音人逻辑
