...
public class Block extends androidx.appcompat.widget.AppCompatButton {
    ...
    public void setDefaults() {
        ...
        this.setBackgroundResource(com.example.saolei.R.drawable.unselected);//设置未翻开背景图
        setBoldFont();
    }

    //设置翻开状态
    public void setNumberOfSurroundingMines(int number) {
        this.setBackgroundResource(com.example.saolei.R.drawable.selected);//设置翻开背景图
        updateNumber(number);//设置周围雷数
    }

    //添加雷块标识
    public void setMineIcon() {
        this.setBackgroundResource(com.example.saolei.R.drawable.dl);
    }
    ...
    public void setFlagIcon(boolean enabled) {
        ...
        if (!enabled) {
            this.setBackgroundResource(com.example.saolei.R.drawable.hq);
        } else {
    ...
    public void clearAllIcons() {
        this.setText("");
        this.setTextColor(com.example.saolei.R.drawable.unselected);
    }
