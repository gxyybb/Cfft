...
public class FileUtil {
    ...
    // 获取外部存储的公共目录
    public static String getExternalStoragePublicDirectory(String dirType) {
    ...
    public static String createTmpDir(Context context) {
        ...
        String tmpDir = getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS) + File.separator + sampleDir;
        if (!makeDir(tmpDir)) {
            tmpDir = context.getExternalFilesDir(sampleDir).getAbsolutePath();
            if (tmpDir == null || !makeDir(tmpDir)) {
